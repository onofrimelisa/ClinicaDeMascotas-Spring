...
--
-- Servidor: localhost
-- Tiempo de generación: 15-11-2019 a las 18:25:21
...
INSERT INTO `Evento` (`id`, `descripcion`, `diagnostico`, `droga`, `fecha`, `indicaciones`, `observaciones`, `peso`, `mascota_id`, `tipo_id`, `usuario_creador_id`) VALUES
(1, 'Una descripcion', 'Diagnostico', 'Drogas', '2020-03-31', 'Indicaciones', 'Sin Observaciones', 15.4, 1, 3, 4);
...
INSERT INTO `Mascota` (`id`, `color`, `especie`, `fecha_nacimiento`, `nombre`, `raza`, `senias`, `sexo`, `duenio_id`, `ficha_publica_id`, `veterinario_id`) VALUES
(1, 'Negro', 'Perro', '2010-03-31', 'Henry', 'Bulldog', 'Se sienta si le decís SIT', 'Masculino', 4, NULL, NULL),
(2, 'Amariliou', 'Gato', '2010-03-31', 'Raquel', 'Rubia', 'Operada', 'Femenino', 2, NULL, 3);
...
INSERT INTO `Usuario` (`id`, `activo`, `apellido`, `domicilio_consultorio`, `email`, `fecha_nacimiento`, `matricula`, `nombre`, `nombre_consultorio`, `password`, `telefono`) VALUES
(2, b'1', 'ApellidoTest', NULL, 'test@test.com', '1999-03-31', NULL, 'NombreTest', NULL, '123456', '452710'),
(3, b'1', 'ApellidoDuenio', NULL, 'test_roles@test.com', '1999-03-31', NULL, 'NombreDuenio', NULL, '123456', '452710'),
(4, b'1', 'ApellidoDuenio', NULL, 'test_con_mascota@test.com', '1999-03-31', NULL, 'NombreDuenio', NULL, '123456', '452710');
